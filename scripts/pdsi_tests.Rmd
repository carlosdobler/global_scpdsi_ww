...
The following figure shows correlation coefficients between my results and Van der Schrier's PDSI at a month level (i.e. my resulting map at *t* n vs. VDS resulting map at *t* n):    
...
If I randomly choose a date when correlation was **high-ish**, the two maps look like this:    
